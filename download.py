...
with open('datos.csv', 'r') as file, open('output.csv', 'w') as file1:
    next(file)
    for line in file:
        file1.write(line)
...
with open('output.csv', newline='') as csvfile:
    ...
    for row in csv_data:
        cursor.execute('INSERT INTO contel(callid,timestart,callfrom,callto,callduraction,talkduraction,srctrunkname,dsttrunkname,status,type,pincode,recording,didnumber,sn) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)', row)
